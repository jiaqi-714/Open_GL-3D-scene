...
namespace {
    ...
    material_t make_mat(const material_param_t &params) {
        ...
        return material_t{
            params.diffuse, params.emissive,
            diff,
            spec,
        };
    }
...
model_t make_pyramid(const volume_param_t &geo_params, const material_param_t &mat_params) {
    return model_t{ make_pyramid_mesh(), make_mat(mat_params) };
}